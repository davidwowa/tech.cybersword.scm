...
\newline
\newline
% You want to upgrade you linux system.\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\vspace{1em}\newline
% Use {gc or Get-Content commands}\newline
\vspace{1em}\newline
% apt-get -y update && apt-get -y upgrade && apt-get -yd dist-upgrade && apt-get -y autoclean && apt-get -y purge && apt-get -y autoremove && apt-get -y remove && apt-get -y clean && apt-get -y autoremove --purge && reboot\newline
\newline
% - {\small{ex.:}} gc filename {\small{or}} Get-Content filename\newline
% - {\small{ex.:}} gc filename -tail 0 -wait {\small{or}} Get-Content filename -tail 0 -wait\newline
% - {\small{ex.:}} gc filename | select-string -pattern pattern \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
