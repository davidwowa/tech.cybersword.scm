...
\newline
\newline
Each {\large{activity}} during penetration test has different goal, \newline
therefore {\large{organize}} each activity at least to following categories:
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\textbf{Reconnaissance} - active {\large{nmap, API}} and passive {\large{nslookup, OSINT}} \newline
\newline
\textbf{Exploit Build, PoC} - {\large{Java, Python \dots}} \newline
\newline
\textbf{Exploit Run} - {\large{logs, screenshots, evidences}} \newline
\newline
\textbf{Report, Evidences} - {\large{PDF, hash, signature}} \newline
};
% ------------------------------------------------------------------------------------------------------------------------------
