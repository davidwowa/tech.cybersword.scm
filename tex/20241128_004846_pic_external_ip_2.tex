...
\newline
\newline
{\Large You will know the external IP.(V.2)}
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
{\large{whatismyip}} - curl whatismyip.akamai.com \newline
{\large{ipify}} - curl api.ipify.org \newline
{\large{wtfismyip}} - curl wtfismyip.com \newline
{\large{wtfismyip + TorInfo}} - curl wtfismyip.com/json \newline
};
% ------------------------------------------------------------------------------------------------------------------------------
