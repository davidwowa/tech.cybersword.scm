...
\newline
\newline
During pentest you have a keyboard and see on the screeen 
\newline
{\huge{user@hostname:~\$}}, 
\newline
{\huge{root@system:~\$}} or 
...
\newline
\newline
{\huge{htop}} or {\huge{top}} - list system processes and their resources\newline
{\huge{iotop}} - list I/O usage by processes\newline
{\huge{iftop}} - list network usage by processes\newline
{\huge{ss -tulnp}} or {\large{netstat -tulnp}} - list network connections\newline
{\huge{dmesg}} - list last kernel log\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
