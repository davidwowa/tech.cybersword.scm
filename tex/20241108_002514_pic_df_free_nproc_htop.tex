...
\newline
\newline
You start system overview in pentest, you need to know which partitions are present, how is memory construction or how many CPU-cores on system. \newline
\newline
Use 
\newline
{\huge{df}}, {\huge{free}}, {\huge{nproc}} and {\huge{htop}}\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
{\large{df -h}} - list partitions on system with human readable size \newline
{\large{free -h}} - show RAM and swap \newline
{\large{nproc}} - list number of cores \newline
{\large{htop}} - if present, show current system status with running processes and so on \newline
};
% ------------------------------------------------------------------------------------------------------------------------------
