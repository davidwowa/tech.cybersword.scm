...
\begin{quote}
{\Large ``Program testing can be a very effective way to show the presence of bugs, but is hopelessly inadequate for showing their absence.''}\\
\vspace{1em}
\hfill -- {\Large \textit{Edsger W. Dijkstra, Turing Award Lecture, 1972}}
\end{quote}
\vspace{3em}
{\Large "Think about it when you see the software development reports."}
};
% ------------------------------------------------------------------------------------------------------------------------------
