...
% ------------------------------------------------------------------------------------------------------------------------------
\node[green, anchor=north west, font=\ttfamily\fontsize{18}{19}\selectfont, text width=10.6cm, align=center] at (0.1,10.25) {
% \begin{listings}
\newline
\newline
\newline
Cybersecurity isn't based on probability, but on code and knowledge.
% \end{listings}
};
% ------------------------------------------------------------------------------------------------------------------------------
