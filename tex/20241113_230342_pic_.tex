...
\newline
\newline
You start system {\large{overview}} in pentest, you need to know which {\large{partitions}} are present, how is {\large{memory}} construction or how many {\large{CPU-cores}} on system. \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
