...
\newline
\newline
Do you want to {\Large{read data}} from a device over a {\Large{serial port}}? UART, USB-Serial, COM-Ports \dots\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\large{screen /dev/tty.usbdevice 9600}} command.\newline
\newline
{\large{/dev/tty.usbdevice}} - your connected device \newline
{\large{9600}} - Baudrate \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
