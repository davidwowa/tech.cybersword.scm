...
\newline
\newline
You will find file or folder, {\huge{find}} your best friend.\newline
Or you search specific files on sysmtem, for example only files.
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Following command can help you: \newline
{\huge{\texttt{find / -name "*.key"}}}\newline
other one \newline 
{\Large\texttt{find / -name "passwords.txt" 2>/dev/null}}\newline
For file searh onlyuse: \newline
{\Large\texttt{find / -type f -name "passwords.txt" 2>/dev/null}}\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
