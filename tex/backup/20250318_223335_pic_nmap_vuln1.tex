...
\newline
\newline
Do you want to {\Large{start an Nmap scan with known vulnerabilities}}?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\large{nmap --script vuln 192.168.178.1 -oN log.log --reason}} command.\newline
\newline
{\large{--script vuln}} - use Nmap vulnerabilities script for scan \newline
{\large{192.168.178.1}} - IP for scan \newline
{\large{-oN log.log}} - save output in logfile \newline
{\large{--reason}} - reason for port status \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
