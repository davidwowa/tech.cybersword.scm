...
\newline
\newline
{\Large You need to encrypt and decrypt a message with a password.} \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\vspace{1em}\newline
\#encrypt\newline
{\small{echo secret | openssl aes-256-cbc -pbkdf2 -a -salt -pass pass:test}}\newline
\vspace{1em}\newline
\#decrypt\newline
{\small{echo encString | openssl aes-256-cbc -pbkdf2 -d -a -pass pass:test}}\newline
\vspace{2em}\newline
{\large{secret}} is the message to encrypt and {\large{test}} is the password.\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
