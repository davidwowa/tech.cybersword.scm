...
\newline
\newline
Do you want to {\Large{list many files and filter by different names with a single command}}?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{grep}} with the {\Large{-E}} flag and {\Large{regex}} to filter by multiple names at once.\newline
\newline
Example: {\Large{ls -lah | grep -E 'name1|name2|name3'}}\newline
}
% ------------------------------------------------------------------------------------------------------------------------------
