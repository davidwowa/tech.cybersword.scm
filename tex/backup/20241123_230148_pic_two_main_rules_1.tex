...
\node[green, anchor=north west, font=\ttfamily\fontsize{8}{9}\selectfont, text width=10.6cm, align=center] at (0.1,10.25) {
    \begin{quote}
        {\Large ``For the following things, there is no forgiveness in cybersecurity:
        
        \vspace{1em} % Funktioniert jetzt, da davor ein Absatzende ist
        
        1. No backups
        
        \vspace{1em} % Funktioniert jetzt
        
        2. No regular updates.''}
        
        \vspace{2em} % Funktioniert für den Abstand zum Autor
        
        \hfill -- {\large \textit{"Unknown cool cybersecurity expert"}}
        \end{quote}        
\vspace{3em}
{\Large "Think about it when you design a system."}
};
% ------------------------------------------------------------------------------------------------------------------------------
