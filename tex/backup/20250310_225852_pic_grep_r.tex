...
\newline
\newline
Do you want to {\Large{search for a string in files within a folder}}?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{grep}} command.\newline
\newline
{\Large{grep -r "string" folder}}\newline
{\Large{-r}} recursive search \newline
{\Large{folder}} folder to search \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
