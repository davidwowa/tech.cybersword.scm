...
\newline
\newline
Do you want to {\Large{securely delete files}}?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{shred}} command.\newline
\newline
{\Large{shred -v -n 10 -u -z file}}\newline
{\Large{-v}} verbose mode\newline
{\Large{-n 10}} rewrites number, minimal 3\newline
{\Large{-u}} truncate and remove file after overwriting\newline
{\Large{-z}} add final overwrite with zeros\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
