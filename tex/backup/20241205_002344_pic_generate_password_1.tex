...
\newline
\newline
You want to generate a {\Large{random password}} in shell.\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\vspace{1em}\newline
Use {\Large{openssl rand -base64 32}} or\newline {\Large{openssl rand -hex 15}}\newline
\vspace{1em}\newline
The OpenSSL tool contains a set of cryptographic operations, including encryption, hashing, and random number generation.\newline
\newline
rand - means random numbers\newline
-base64 - encoding, so is possible to copy and trnasfer data\newline
