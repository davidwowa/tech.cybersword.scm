...
\newline
\newline
Each {\large{activity}} during penetration testing requires a different set of tools. \newline
{\large{Organize}} each activity according to the common security {\LARGE{CIA}} triad.
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
{\large{C}}onfidentiality - {\large{openssl, chmod \dots}} \newline
{\large{I}}ntegrity - {\large{sha512sum, diff \dots}} \newline
{\large{A}}vailability - {\large{top, ping \dots}} \newline
};
% ------------------------------------------------------------------------------------------------------------------------------
