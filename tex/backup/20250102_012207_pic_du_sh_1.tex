...
\newline
\newline
Do you want to list all folders and files and find out their sizes?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{du -sh * 2>/dev/null}}\newline
\newline
% \vspace{1em}
\newline
{\Large{137M}}	AndroidStudioProjects\newline
{\Large{726M}}	DEV\newline
{\Large{167G}}	Desktop\newline
\newline
- {\Large{sh}} - size human readable\newline
- {\Large{*}} - all files and folders (current filesystem position)\newline
- {\Large{2>/dev/null}} - ignore errors\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
