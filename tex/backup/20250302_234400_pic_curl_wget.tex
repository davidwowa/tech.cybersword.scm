...
\newline
\newline
During penetration tests, you want {\Large{to download something}}.\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{wget}} or {\Large{curl}} commands.\newline
\newline
{\Large{wget https://example.com/data.zip}}\newline
or\newline
{\Large{curl -O https://example.com/data.zip}}\newline
option {\Large{-O}} saves the file with the same name.\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
