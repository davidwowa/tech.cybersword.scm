...
\newline
\newline
Do you need to {\Large{copy files in the terminal from one IP to another}}?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\begin{scriptsize}
\begin{lstlisting}
For file copy:   scp folder/file user@192.168.133.7:/home/user/
For folder copy: scp -r folder/ user@192.168.133.7:/home/user/
\end{lstlisting}
\end{scriptsize}
};
% ------------------------------------------------------------------------------------------------------------------------------
