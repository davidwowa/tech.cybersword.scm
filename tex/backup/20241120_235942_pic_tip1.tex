...
\newline
\newline
{\large{Bash, PowerShell, DOS}} - basic system commands, scripting, automation and exploration
\newline
\newline
{\large{C/C++/Java/Python/JavaScript}} - programming languages, you should know at least one of them, decide between functional and object-oriented programming languages
\newline
\newline
{\large{classic software/product design patterns}} - for better understanding of code and architecture
};
% ------------------------------------------------------------------------------------------------------------------------------
