...
\newline
\newline
Do you want to {\Large{to see the first or last lines in a file}}?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{head}} or {\Large{tail}} command.\newline
\newline
head for start and tail for end of file\newline
\newline
{\Large{head -n 10 file}} - show first 10 lines of file \newline
{\Large{tail -n 10 file}} - show last 10 lines of file \newline
{\Large{tail -f file}} - observe end of file, good for log files observation \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
