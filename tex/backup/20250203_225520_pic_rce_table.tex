...
\node[red, anchor=north west, font=\ttfamily\bfseries\fontsize{8}{9}\selectfont] at (0.1,10.65) {NVD DB RCE Update};
% % ------------------------------------------------------------------------------------------------------------------------------
...
\begin{tabularx}{\textwidth}{|p{2cm}|p{1cm}|p{7cm}|}
\hline
\textbf{CVE ID} & \textbf{Score} & \textbf{Component} \\
\hline
CVE-2021-34527 & 9.8 & Print Spooler parambabambimumbimamaim \\
\hline
CVE-2021-44228 & 10.0 & Log4j \\
\hline
CVE-2020-1472 & 10.0 & Netlogon \\
\hline
CVE-2019-0708 & 9.8 & Remote Desktop Services \\
\hline
\end{tabularx}
