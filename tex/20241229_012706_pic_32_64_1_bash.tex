...
\newline
\newline
You have shell access and need to know is system {\Large{32}} or {\Large{64 bit}}.\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
\newline
Use {\Large{file /bin/bash}}\newline
\newline
% \vspace{1em}
\newline
- /bin/bash: ELF {\Large{32-bit or 64-bit}} LSB executable, ARM, EABI5 version 1 (SYSV), dynamically linked, \dots\newline
\newline
\newline
\newline
};
