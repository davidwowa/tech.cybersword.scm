...
\newline
\newline
{\Large You're new to the project and have absolutely no idea where the beginning or the end is. } \newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\vspace{1em}\newline
{\Large{Start with Software Component Analysis (SCA), Software Supply Chain (SSC), or Software Bill of Materials (SBOM). Nowadays, over 50\% of the code in a project is written by third parties, meaning their security issues are part of your project. Track and manage these with the appropriate tools.}}\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
