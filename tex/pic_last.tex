...
\newline
\newline
Do you want to list {\Large{all reachable IP's}} in the network?\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
% \vspace{1em}
\newline
In this example your ip is 192.168.178.13\newline
Use {\Large{nmap -sn 192.168.178.1/24}}\newline
Replace last ip part {\Large{13}} through {\Large{1/24}}\newline
\vspace{1em}\newline
Starting Nmap 7.95 ( https://nmap.org ) at 2025-12-13 13:37 CET\newline
Nmap scan report for target (192.168.178.1)\newline
