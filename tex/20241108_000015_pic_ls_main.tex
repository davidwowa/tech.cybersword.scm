...
\newline
\newline
You are tired and have to continue the pentest, you need an overview in a folder. \newline
\newline
Use {\huge{ls}}\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
\newline
Normaly you can use the {\large{ls}} to list folder content. \newline
But if you use also options like {\large{-l, -a, -h, -t, -s, -S, -r}},  \newline
{\large{ls -l}} - output as list \newline
{\large{ls -la}} - output as list and all also hided files/folders\newline
{\large{ls -lah}} - user human output for sizes, also KB,MB\dots \newline
{\large{ls -laht}} - sort by date \newline
{\large{ls -lahtr}} - sort by date, {\large{-r}} is for reverse sort \newline
{\large{ls -lahS}} - sort by size \newline
};
% ------------------------------------------------------------------------------------------------------------------------------
