...
\newline
\newline
You want to create a {\Large{professional penetration test report}}.\newline
\newline
\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
...
Use {\Large{\LaTeX}}\newline
\vspace{1em}\newline
With {\Large{\LaTeX}} is possible to create structured, high-quality report.\newline
\newline
- Templates are possible\newline
- Support for code and syntax highlighting\newline
- Charts and graphs, vector-oriented design\newline
- Possibility to attach files and logs\newline
};
% ------------------------------------------------------------------------------------------------------------------------------
